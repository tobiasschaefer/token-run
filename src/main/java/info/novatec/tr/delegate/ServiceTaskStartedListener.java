...
@Named
public class ServiceTaskStartedListener implements ExecutionListener {
	...
	public void notify(DelegateExecution execution) throws Exception {
		System.out.println(" Listened to task startet for: " + execution.getProcessInstanceId() + ". "+findTaskId(execution.getActivityInstanceId()) + " name: " + execution.getCurrentActivityName());
		controller.serviceTaskCreated(execution.getProcessInstanceId(), findTaskId(execution.getActivityInstanceId()), findTaskName(execution.getActivityInstanceId()));
	}
